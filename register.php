<?php
	...
	$fname = clean($_POST['signup_firstname']);
	$lname = clean($_POST['signup_lastname']);
	$login = clean($_POST['signup_username']);
	$password = clean($_POST['signup_password']);
	$cpassword = clean($_POST['signup_repassword']);
	...
	//Create INSERT query
	$qry = "INSERT INTO members(firstname, lastname, login, passwd) VALUES('$fname','$lname','$login','".md5($_POST['signup_password'])."')";
	$result = @mysqli_query($GLOBALS["___mysqli_ston"], $qry);
