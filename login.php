<?php
	...
	$login = clean($_REQUEST['login_username']);
	$password = clean($_REQUEST['login_password']);
	...
	//Create query
	$qry="SELECT * FROM members WHERE login='$login' AND passwd='".md5($_REQUEST['login_password'])."'";
